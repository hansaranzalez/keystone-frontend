<template>
  ...
  >
    ...
    <div class="w-full max-w-md block sm:hidden text-center space-y-6">
      <!-- Success Icon -->
      <div class="flex items-center justify-center">
        <UIcon name="i-heroicons-envelope-check" class="text-blue-500 text-6xl" />
      </div>

      <!-- Success Message -->
      <h2 class="text-xl font-medium text-white">
        {{ $t('auth.passwordResetRequestSuccess.title') }}
      </h2>
      <p class="text-gray-400">
        {{ $t('auth.passwordResetRequestSuccess.message') }}
      </p>
      ...
      >
        {{ $t('auth.passwordResetRequestSuccess.backToLogin') }}
      </UButton>
    </div>
    ...
    >
      <UCardBody class="text-center space-y-6">
        <!-- Success Icon -->
        <div class="flex items-center justify-center">
          <UIcon name="i-heroicons-envelope-check" class="text-blue-500 text-6xl" />
        </div>
